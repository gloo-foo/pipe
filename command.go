...
func (p command) Executor() gloo.CommandExecutor {
	return func(ctx context.Context, stdin io.Reader, stdout, stderr io.Writer) error {
		...
		for i, cmd := range commands {
			...
			go func(index int, command gloo.Command, in io.Reader, out io.Writer, pipeIn *io.PipeReader) {
				defer wg.Done()
...
func args[O any](parameters ...any) (result PipeInputs[O]) {
	var (
		options []gloo.Switch[O]
	)
